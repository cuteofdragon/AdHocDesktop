...
namespace Microsoft.DirectX.DirectShow
{
    ...
    {
		/// <summary> DirectShows Filters </summary>
		public static readonly Guid DirectShowFilters = new Guid("083863F1-70DE-11d0-BD40-00A0C911CE86");
	...
	public class MediaSubType
	{
		...
		/// </summary>
		public static readonly Guid MPEG2_VIDEO = new Guid("e06d8026-db46-11cf-b4d1-00805f6cbbea");				
		...
		/// </summary>
		public static readonly Guid WMAudioV7 = new Guid("00000161-0000-0010-8000-00AA00389B71");
		
		/// <summary>
		/// WMMEDIASUBTYPE_WMAudioV2
		/// </summary>
		public static readonly Guid WMAudioV2 = new Guid("00000161-0000-0010-8000-00AA00389B71");
		
		/// <summary>
		/// WMMEDIASUBTYPE_ACELPnet
		/// </summary>
		public static readonly Guid ACELPnet = new Guid("00000130-0000-0010-8000-00AA00389B71");
		...
		/// </summary>
		public static readonly Guid WebStream = new Guid("776257d4-c627-41cb-8f81-7ac7ff1c40cc");
