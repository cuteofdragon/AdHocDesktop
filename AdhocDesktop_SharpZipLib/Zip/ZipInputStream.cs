...
using AdHocDesktop.SharpZipLib.Checksums;
using AdHocDesktop.SharpZipLib.Zip.Compression;
using AdHocDesktop.SharpZipLib.Zip.Compression.Streams;

namespace AdHocDesktop.SharpZipLib.Zip 
{
	/// <summary>
	...
	/// using System.IO;
	/// 
	/// using AdHocDesktop.SharpZipLib.Zip;
	/// 
	/// class MainClass
	/// {
	...
	public class ZipInputStream : InflaterInputStream
	{
		...
		/// </exception>
		/// <exception name="AdHocDesktop.SharpZipLib.ZipException">
